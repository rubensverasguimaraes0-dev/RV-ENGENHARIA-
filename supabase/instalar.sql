...
-- ###########################################################################
-- 0010_pagamento_funcionario.sql
-- ###########################################################################
...
begin
  ...
  if v_tabelas <> 37 or v_parametros <> 38 or v_buckets <> 5 or v_sem_rls <> 'nenhuma' then
    raise exception
      'Instalacao incompleta: % tabelas (esperado 37), % parametros (esperado 38), % buckets (esperado 5), sem protecao: %. Nada foi gravado.',
